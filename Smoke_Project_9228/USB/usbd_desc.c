...
#define USBD_MANUFACTURER_STRING    "STWS4EGT" 

#define USBD_PRODUCT_FS_STRING      "HID Transfer" 

#define USBD_CONFIGURATION_FS_STRING "USBD_CONFIGURAT"
#define USBD_INTERFACE_FS_STRING     "STW ECIGE"  
...
//  Device_Serial0 += Device_Serial2;
	////////////////
  Device_Serial0=0x20803875;
	Device_Serial1=0x82406595;
  if (Device_Serial0 != 0)
  {
